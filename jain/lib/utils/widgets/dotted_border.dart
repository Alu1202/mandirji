...
class DottedDecoration extends Decoration {
  ...
  BoxPainter createBoxPainter([VoidCallback? onChanged]) {
    return _DottedDecotatorPainter(
        isLast, shape, linePosition, color, borderRadius, dash, strokeWidth);
  }
}
...
class _DottedDecotatorPainter extends BoxPainter {
  ...
  List<int> dash;
  double strokeWidth;
  _DottedDecotatorPainter(this.isLast, this.shape, this.linePosition,
      this.color, this.borderRadius, this.dash, this.strokeWidth) {
